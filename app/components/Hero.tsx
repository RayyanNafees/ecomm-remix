  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-cream">
      ...
      <div className="container relative z-10 px-4 mx-auto text-center">
        ...
        >
          Discover our curated collection of exquisite fragrances, crafted for those who appreciate the art of perfumery.
        </motion.p>
        ...
        >
          <button type="button" className="px-8 py-3 text-sm font-medium text-white bg-charcoal rounded-full transition-transform hover:scale-105">
            Explore Collection
          </button>
        </motion.div>
      </div>
